    ...
    <div>
      <div style={styles.resumeContainer} ref={pdfRef}>
        <header style={styles.header}>
          <div>
            <h1 style={styles.nameTitle.h1}>{resumeData.basicInfo?.name || 'John Doe'}</h1>
            <p style={styles.nameTitle.p}>{resumeData.basicInfo?.roll || 'Job Title'}</p>
          </div>
          <div>
            <p style={styles.contactInfo.p}>Email: {resumeData.basicInfo?.email || 'email@example.com'}</p>
            <p style={styles.contactInfo.p}>Phone: {resumeData.basicInfo?.phone || 'Phone Number'}</p>
            <p style={styles.contactInfo.p}>LinkedIn: {resumeData.basicInfo?.linkedin || 'linkedin.com/in/username'}</p>
            <p style={styles.contactInfo.p}>GitHub: {resumeData.basicInfo?.git || 'github.com/username'}</p>
          </div>
        </header>
        <div style={styles.columns}>
            ...
            <section style={styles.section}>
              ...
              {resumeData.educationInfo?.map((education, index) => (
                <div key={index}>
                  ...
                  <p>Graduated: {education.graduate || 'N/A'}</p>
                </div>
              ))}
            </section>
            <section style={styles.section}>
          ...
          <div style={styles.rightColumn}>
            <section style={styles.section}>
              ...
              <p>{resumeData.basicInfo?.summary || 'Professional summary goes here.'}</p>
            </section>
            <section style={styles.section}>
